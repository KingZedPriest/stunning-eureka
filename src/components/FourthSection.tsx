        ...
        <main className="py-[8rem] px-4 sm:px-10 md:px-12 lg:px-14 bg-white">
            ...
            <div className="mt-8">
             <div className="flex gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8">
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col py-4 px-2 items-center justify-center hover:bg-blue duration-500">
