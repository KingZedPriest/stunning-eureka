        ...
        <main className="py-[8rem] px-4 sm:px-10 md:px-12 lg:px-14 bg-white">
            ...
            <div className="mt-8">
             <div className="flex gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8">
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <FiTruck size={36} className="text-orange group-hover:text-white"/>
                ...
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <LiaShipSolid size={36} className="text-orange group-hover:text-white"/>
                    <p className="mt-2 group-hover:text-white duration-500 text-sm sm:text-base md:text-lg lg:text-xl">International Delivery</p>
                    <p className="mt-2 hidden md:block group-hover:text-white text-xs"> Seamless shipping solutions for global destinations.</p>
                </div>
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <HiOutlineBriefcase size={36} className="text-orange group-hover:text-white"/>
             ...
             <div className="flex gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8 mt-2 sm:mt-4 md:mt-6 lg:mt-8">
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <BiPlanet size={36} className="text-orange group-hover:text-white"/>
                ...
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <TbTruckDelivery size={36} className="text-orange group-hover:text-white"/>
                ...
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <GiDeliveryDrone size={36} className="text-orange group-hover:text-white"/>
             ...
             <div className="flex gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8 mt-2 sm:mt-4 md:mt-6 lg:mt-8">
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <LuMonitorCheck size={36} className="text-orange group-hover:text-white"/>
                ...
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <BsCreditCard size={36} className="text-orange group-hover:text-white"/>
                ...
                <div className="group w-1/3 text-center font-bold shadow-sm bg-bgWhite h-36 flex flex-col p-4 items-center justify-center hover:bg-blue duration-500">
                    <BsClipboardData size={36} className="text-orange group-hover:text-white"/>
                    <p className="mt-2 group-hover:text-white duration-500 text-sm sm:text-base md:text-lg lg:text-xl">Data App Management</p>
